...
public class CompanyServiceTest extends AbstractTest {
	...
	public void CreateCompanyService() {
		final Object testingData[][] = {
			{//Positive test
				"Nuevo Nombre", "Apellido", "ES12345678X", "prueba@email.com", "NuevoUsername", "NuevaPassWord", "NuevaPassWord", "NuevoBrandName", "NuevoholderName", 9876785, 8, 2020, 876, "NombreCompañia", null
			}, {//Negative test: nameCompany vacio
				"Nuevo Nombre", "Apellido", "ES12345678X", "prueba2@email.com", "NuevoUsername", "NuevaPassWord", "NuevaPassWord", "NuevoBrandName", "NuevoholderName", 9876785, 8, 2020, 876, "", NullPointerException.class
	...
	protected void CreateCompanyTemplate(final String name, final String surnames, final String vatNumber, final String email, final String username, final String password, final String confirmPassword, final String brandName, final String holderName,
		final int number, final int expirationMonth, final int expirationYear, final int cW, final String nameCompany, final Class<?> expected) {
		Class<?> caught;
	...
	public void EditCompanyService() {
		final Object testingData[][] = {
			{
				//Positive test
				"Nuevo Nombre", "Apellido", "ES12345678X", "prueba@email.com", "NuevaPassWord", "NuevaPassWord", "NuevoBrandName", "NuevoholderName", 9876785, 8, 2020, 876, super.getEntityId("company1"), "NombreCompañia", null
			}, {
				//Negative test: Una company intenta modificar los datos de otra
				"Nuevo Nombre", "Apellido", "ES12345678X", "prueba@email.com", "NuevaPassWord", "NuevaPassWord", "NuevoBrandName", "NuevoholderName", 9876784, 8, 2020, 876, super.getEntityId("company2"), "NombreCompañia", IllegalArgumentException.class
		...
		for (int i = 0; i < testingData.length; i++)
			this.EditCompanyTemplate((String) testingData[i][0], (String) testingData[i][1], (String) testingData[i][2], (String) testingData[i][3], (String) testingData[i][4], (String) testingData[i][5], (String) testingData[i][6],
				(String) testingData[i][7], (int) testingData[i][8], (int) testingData[i][9], (int) testingData[i][10], (int) testingData[i][11], (int) testingData[i][12], (String) testingData[i][13], (Class<?>) testingData[i][14]);
	}
	protected void EditCompanyTemplate(final String name, final String surnames, final String vatNumber, final String email, final String password, final String confirmPassword, final String brandName, final String holderName, final int number,
